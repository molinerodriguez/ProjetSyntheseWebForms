...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DropDownList ID="cmbFiliale" runat="server" OnSelectedIndexChanged="cmbFiliale_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList><br/>
    ...
    <asp:TextBox ID="txtNumArticle" runat="server" Enabled="false"></asp:TextBox><br/>
