...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gridArticles" runat="server" Height="50px" Width="125px" OnSelectedIndexChanged="gridArticles_SelectedIndexChanged" AutoGenerateDeleteButton="False" AutoGenerateSelectButton="True">
    </asp:GridView><br/>
    ...
    <asp:GridView ID="gridViewCommande" runat="server" Height="50px" Width="125px" AutoGenerateDeleteButton="True" OnRowDeleting="gridViewCommande_RowDeleting">
    </asp:GridView><br/>
